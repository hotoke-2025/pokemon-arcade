  ...
  return (
    <>
      ...
      <div className="flex justify-center space-x-32">
        <Link to="/game-1"><p className="whitespace-nowrap">Pokemon Battle</p></Link>
        <Link to="/game-2"><p className="mx-auto whitespace-nowrap">Who&apos;s that Pokemon!</p></Link>
        <Link to="/game-3"><p className="whitespace-nowrap"> Tic-Tac-Johto</p></Link>
      </div>
